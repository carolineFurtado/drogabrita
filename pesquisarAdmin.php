    ...
    <body>
                                                 ...
                                                 echo'<div class="card-body">';
                                                        echo '<div class="d-flex justify-content-between align-items-center">';
                                                            echo'<div class="btn-group">';
                                                                echo '<button style ="text-align: center;">' . $remedios["produto"] . '</button>';
                                                                echo '<button style ="text-align: center;"> R$'. $remedios["valor"].'</button>';
                                                                echo'<p><a href="Javascript:editar('. $remedios["id"] .')">Editar</a></p>';
                                                                echo '<p><a href="Javascript:excluir(' . $remedios["id"] . ')">Excluir</a></p>';
                                                            echo '</div>';
                                                        echo'</div>';
                                                    echo'</div>';    
                                                echo '</div>';     
         ...
         <footer class="text-muted">
            <div class="container">
                ...
                <p>Album example is &copy; Bootstrap, customizado por Caroline Furtado e Geremias Pereira!</p>        
            </div>
    </footer>
